                        ...
                        <div class="card-body">
                            <form action="update_users.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country_id" class="form-control" required>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($countries)): ?>
                                            <option value="<?= $row['id'] ?>" <?= $row['id'] == $user['country_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Leave this empty to keep the current
                                        image.</small>
                                    <br>
                                    <img  src="images/<?= $user['image'] ?>" width="40" height="40"
