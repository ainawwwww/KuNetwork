...
//image upload start
    ...
    //     $maxHeight = 1080; // Maximum height
         ...
         $upload_query="INSERT INTO `categories_level3`(`name`, `parent_catid`, `menu_status`, `product_filter_sidebar_status`) VALUES ('$cat_name','$cat2','$sidebar_status','$menu_status')";
