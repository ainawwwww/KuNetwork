    ...
    $uploadStatus=0; 
           ...
           if($uploadStatus==1 )
           {
                        ...
                        if (move_uploaded_file($fileTmpName, $uploadPath)) {
                            ...
                            $upload_query="INSERT INTO `categories_level2`( `name`, `parent_catid`, `product_filter_sidebar_status`, `menu_status`, `image`) VALUES ('$cat_name','$cat1','$sidebar_status','$menu_status','$newFileName')";
