...
if(isset($_GET['id']))
{
    ...
    if($result=mysqli_query($conn,$query)) {
      ...
      {
        $upquery="UPDATE `categories_level2` SET `product_filter_sidebar_status`=0 WHERE `id`=".$_GET['id'];

      }
      else{
        $upquery="UPDATE `categories_level2` SET `product_filter_sidebar_status`=1 WHERE `id`=".$_GET['id'];
