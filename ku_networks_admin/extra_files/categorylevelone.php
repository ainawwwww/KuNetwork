...
if (isset($_SESSION['role']) && $_SESSION['role']==1){
  $fetch="UPDATE `categories_level1` SET `read_status`=1 WHERE read_status=0";
  ...
  <div class="content-wrapper">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Level One Categories</h3>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
      $fetch_query="SELECT * FROM `categories_level1`";
    ...
    ?>
       <tr>
        ...
        <td><a href="action/update_category_filter_status.php?id=<?=$row['cat_id']?>">
        ...
        <td><a href="action/update_menu_status.php?id=<?=$row['cat_id']?>">
        ...
        <td><?=$row['navbar_description']?></td>
          <td><?=$row['created_at']?></td>
              ...
              <td>
               ...
               <a href="update_category1.php?id=<?= $row['cat_id'] ?>"><button class="btn btn-info btn-sm mx-2"  style="border-radius:15px;"  ><i class="fas fa-pencil-alt"></i></button></a>
               <a href="action/delete_cat1.php?id=<?= $row['cat_id'] ?>">
