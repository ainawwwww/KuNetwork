...
if(isset($_POST['delete'])) {
  $id=$_POST['id'];
  $sql="DELETE FROM `packaging_products` WHERE `id`='$id'";
  if(mysqli_query($conn,$sql)) {
  header("location:packaging_products.php");
  }
  else{
      echo "error";
  }
...
if(isset($_POST['add_pro'])){
  ...
  $insert_query="INSERT INTO `packaging_products`(`product_id`) VALUES ('$products')";
 
  if(mysqli_query($conn,$insert_query)) {
      echo "<script>window.location='packaging_products.php';</script>";
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card-header">
            <h3 class="card-title">Add a new specific Packaging Product</h3>
          ...
          <!-- /.card-body -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Packaging products</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $num=1;
      $fetch_query="SELECT * FROM `packaging_products`";
