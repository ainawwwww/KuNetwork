          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <form action="action/add_order.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                      ...
                      <label for="customFile" id="fileLabel">No file selected</label>
                ...
                <div class="form-group">
                  <label>Price</label>
                  <input type="text" class="form-control" name="p_price" required id="exampleInputEmail1" placeholder="Enter Product Price">
                </div>
                <div class="form-group">
                  <label>Advanced</label>
                  <input type="text" class="form-control" name="advanced_price" required id="exampleInputEmail1" placeholder="Enter Advanced Price">
                </div>
                <div class="form-group">
                  <label>Pending</label>
                  <input type="text" class="form-control" name="pending_price" required id="exampleInputEmail1" placeholder="Enter Pending Amount">
                </div>
                 <div class="form-group">
                  <label>Quantity</label>
                  <input type="number" class="form-control" name="p_quantity" required id="exampleInputEmail1" placeholder="Enter Product Quantity">
                </div>
                 <div class="form-group">
                  <label>Size</label>
                  <input type="text" class="form-control" name="p_size" required id="exampleInputEmail1" placeholder="Enter Product Size">
                </div>
                  ...
                  <!-- radio -->
                    <div class="form-group clearfix">
                      ...
                      <div class="icheck-dark d-inline">
                        <input type="radio" id="radioPrimary2" name="priority" value="Urgent">
                    ...
                    <div class="form-group clearfix">
                      ...
                      <div class="icheck-dark d-inline">
                        <input type="radio" id="radioPrimary11" name="status" checked value="Pending">
                        <label for="radioPrimary11">
                          In Process
                        </label>
                      </div>
                      <div class="icheck-dark d-inline">
                        <input type="radio" id="radioPrimary22" name="status" value="Delivered">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="delivery_date" required id="exampleInputEmail1" >
