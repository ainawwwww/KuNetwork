...
if(isset($_POST['delete'])) {
  $id=$_POST['id'];
  $sql="DELETE FROM `printing_products` WHERE `id`='$id'";
  if(mysqli_query($conn,$sql)) {
  header("location:printing_products.php");
  }
  else{
      echo "error";
  }
...
if(isset($_POST['add_pro'])){
  ...
  $insert_query="INSERT INTO `printing_products`(`product_id`) VALUES ('$products')";
 
  if(mysqli_query($conn,$insert_query)) {
      echo "<script>window.location='printing_products.php';</script>";
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <!-- /.card-body -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Printing products</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $num=1;
      $fetch_query="SELECT * FROM `printing_products`";
