        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Best Sell Product Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Add a new specific Best Selling Product</h3>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <form action="action/insert_best_pro.php" method="post" enctype="multipart/form-data">
