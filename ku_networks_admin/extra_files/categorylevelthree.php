...
if (isset($_SESSION['role']) && $_SESSION['role']==1){
  $fetch="UPDATE `categories_level3` SET `read_status`=1 WHERE read_status=0";
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Level Three Categories</h3>
                <a href="add_category3.php" style="float: right;" class="btn btn-success">Add+</a>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
      $fetch_query="SELECT categories_level3.*,categories_level2.name as parent_cat FROM `categories_level3` 
join categories_level2 on categories_level3.parent_catid=categories_level2.id;";
    ...
    ?>
       <tr>
        ...
        <td><a href="action/update_category3_filter_status.php?id=<?=$row['id']?>">
        ...
        <td><a href="action/update_menu_status_level3.php?id=<?=$row['id']?>">
        ...
        <td><?=$row['parent_cat']?></td>
          ...
          <td><?=$row['created_at']?></td>
              ...
              <td>
               ...
               <a href="update_category3.php?id=<?= $row['id'] ?>"><button class="btn btn-info btn-sm mx-2"  style="border-radius:15px;"  ><i class="fas fa-pencil-alt"></i></button></a>
               
               <a href="action/delete_cat3.php?id=<?= $row['id'] ?>">
